...
def generate_launch_description():
    ...
    launch_description.add_action(
        LogInfo(msg='[manipulator_can_control.launch.py]\033[34mLaunching the Joystick Node\033[0m'
        )
    )
    ...
    launch_description.add_action(
        LogInfo(msg='[manipulator_can_control.launch.py]\033[34mLaunching the Operator Control Node\033[0m'
        )
    )
    ...
    launch_description.add_action(
        LogInfo(
        msg='[manipulator_can_control.launch.py]\033[34mLaunching the CAN motor Node\033[0m'
        )
    )
